    ...
    >
      ...
      <div className="border-t border-gray-800 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-4 text-gray-400 text-lg">
          <a href="#" className="hover:text-white" aria-label="LinkedIn" title="linkedin" target="_blank">
            <svg
              width="1em"
              height="1em"
              viewBox="0 0 24 24"
          ...
          <a href="#" className="hover:text-white" aria-label="GitHub" title="github" target="_blank">
            <svg
              width="1em"
              height="1em"
              viewBox="0 0 24 24"
          ...
          <a href="#" className="hover:text-white" aria-label="Website" target="_blank">
            <svg
              width="1em"
              height="1em"
              viewBox="0 0 24 24"
